...
export const memoryMessages = {
  zh: {
    ...
    ftsLabel: "全文",
    limitLabel: "返回上限：",
    searchConfigNote: "全文检索无需模型配置。",
    results: "搜索结果",
    returned: (count: number) => `本次返回 ${count} 条`,
    browseNote: "当前按搜索结果浏览，完整目录暂不可用。",
    hitFts: "全文命中",
    hitVector: "向量命中",
    none: "没有匹配的记忆。",
    start: "输入关键词查找已有记忆。",
    ...
    reference: "精确引用",
    referenceFull: "完整引用结构",
    copyText: "复制正文",
    copyReference: "复制精确引用",
    copied: "已复制",
  ...
  en: {
    ...
    saving: "Submitting…",
    target: "Save target",
    saveTarget: "Saving to: ",
    writeOnClick: "Written only when you click save",
    ...
    searching: "Searching…",
    clearQuery: "Clear keywords",
    searchModeLabel: "Search mode: ",
    ftsLabel: "Full text",
    limitLabel: "Result limit: ",
    searchConfigNote: "Full-text search needs no model configuration.",
    results: "Search results",
    returned: (count: number) => `${count} returned this time`,
    browseNote: "Browsing by search results; a full catalog is not available.",
    hitFts: "Full-text match",
    hitVector: "Vector match",
