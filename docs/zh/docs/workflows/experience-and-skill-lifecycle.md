...
审核步骤见[审核 Candidate](review-candidates.md)，Experience 操作见
[创建并审核 Experience](create-and-review-experience.md)，Skill 操作见
[创建并导出 managed Skill](create-and-export-skill.md)。
