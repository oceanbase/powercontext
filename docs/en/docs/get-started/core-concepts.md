...
[Memory and Handoff](../workflows/memory-and-handoff.md) for the boundary between durable knowledge and task transfer.
...
[Review Candidates](../workflows/review-candidates.md) for the procedure.
...
the host-local projection. See [Experience and Skill lifecycle](../workflows/experience-and-skill-lifecycle.md) for the full
...
The [Handoff Report](../workflows/use-handoff-report.md) projects the latest Handoff Revision in each selected Scope for
...
Use [Interfaces](../develop/interfaces.md) for current surface availability and
[Configuration](../operate/configuration.md) for exact settings and defaults. RFCs record design decisions and may
