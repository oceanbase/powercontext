...
[HTTP API lifecycle tutorial](../develop/api-quickstart.md) to complete the first governed context loop directly.
...
[Configure Agent Plugin](../integrations/agent-plugin.md) and load
...
[Configure Hermes](../integrations/hermes.md) for activation and command boundaries.
...
Read [Pydantic AI](../integrations/pydantic-ai.md), [LangChain](../integrations/langchain.md), and
[LangGraph](../integrations/langgraph.md). The Bub package is documented in `integrations/bub/README.md`.
...
Continue with the [complete Codex tutorial](../workflows/codex-workflow.md),
[Memory and Handoff](../workflows/memory-and-handoff.md),
[complete work transfer](../workflows/handoff-with-codex.md),
[Full-capability Quick Start](configure-models.md), [Deploy the Server](../operate/deploy-server.md), or
