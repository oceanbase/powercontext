...
| --- | --- | --- | --- | --- |
| codex | Agent host | Master only | minimal, recommended | memory_read<br>memory_write<br>source_capture<br>context_injection<br>flush_or_checkpoint<br>work_contract<br>handoff<br>acknowledge<br>task_outcome<br>candidate_review<br>scope_organization<br>artifact_publication<br>persistent_scope_binding |
| claude-code | Agent host | Master only | minimal, recommended | memory_read<br>memory_write<br>source_capture<br>context_injection<br>flush_or_checkpoint<br>work_contract<br>handoff<br>acknowledge<br>task_outcome<br>candidate_review<br>scope_organization<br>artifact_publication<br>persistent_scope_binding |
...
| pi | Agent host | Master only | minimal, recommended | memory_read<br>memory_write<br>source_capture<br>context_injection<br>flush_or_checkpoint<br>work_contract<br>handoff<br>acknowledge<br>task_outcome<br>experience_read_or_generate<br>skill_read_or_generate<br>candidate_review<br>topic_memory_read<br>pre_compaction_capture<br>slash_command |
| workbuddy | Agent host | Master only | minimal, recommended | memory_read<br>memory_write<br>source_capture<br>context_injection<br>flush_or_checkpoint<br>work_contract<br>handoff<br>acknowledge<br>task_outcome<br>candidate_review<br>scope_organization<br>artifact_publication<br>persistent_scope_binding |
