...
describe('SearchBar Component', () => {
  let onSearchMock: ReturnType<typeof vi.fn<(query: string) => void>>;
  let onClearMock: ReturnType<typeof vi.fn<() => void>>;

  beforeEach(() => {
    onSearchMock = vi.fn<(query: string) => void>();
    onClearMock = vi.fn<() => void>();
  });
  ...
  describe('Rendering', () => {
    ...
    test('should render with custom placeholder', () => {
      render(<SearchBar placeholder="Search memories" />);
  ...
  describe('Input Interaction', () => {
    test('should update input value on change', async () => {
      ...
      const input = screen.getByPlaceholderText('搜索记忆...') as HTMLInputElement;
  ...
  describe('Clear Functionality', () => {
    test('should clear input on clear button click', async () => {
      const user = userEvent.setup();
      render(<SearchBar onClear={onClearMock} onSearch={onSearchMock} />);
    ...
    test('should call onClear callback when clearing', async () => {
      const user = userEvent.setup();
      render(<SearchBar onClear={onClearMock} />);
    ...
    test('should hide clear button after clearing', async () => {
      ...
      clearButton = screen.queryByLabelText('清除') as HTMLElement;
      expect(clearButton).not.toBeInTheDocument();
    });
  });
