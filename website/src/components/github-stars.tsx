...
export function GitHubStars({ lang, url }: { lang: Language; url: string }) {
  ...
  const exactCount = snapshot?.count.toLocaleString(locale);
  ...
  return (
    ...
    >
      <a
        ...
        aria-label={`GitHub${exactCount === undefined ? '' : ` · ${exactCount} stars`} · ${newTab}`}
