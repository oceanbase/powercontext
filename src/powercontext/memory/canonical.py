...
from powercontext.memory.models import MemoryContent

_ENTRY_HASH_DOMAIN = b"powercontext:entry-content:v1\0"
_EMBEDDING_HASH_DOMAIN = b"powercontext:embedding-content:v1\0"
_LOWER_HEX_64 = re.compile(r"[0-9a-f]{64}\Z")

JsonValue: TypeAlias = bool | int | str | float | None | Sequence["JsonValue"] | Mapping[str, "JsonValue"]
...
def canonical_json(value: object) -> bytes:
    """Return RFC 8785 bytes after recursively applying Unicode NFC."""
...
def normalize_reason(value: str | None) -> str | None:
    """Normalize an optional audit reason and enforce its RFC limit."""
...
def validate_identifier(value: str) -> str:
    """Validate an RFC 0003 globally unique identity representation."""
...
def entry_content_hash(
    *,
    ...
    """Hash canonical entry content with the RFC domain separator."""
