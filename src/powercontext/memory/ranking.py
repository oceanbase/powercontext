...
from powercontext.memory.models import MemoryChannelHit, MemoryHit, MemoryMatchedBy
...
class _InvalidLimitError(ValueError):
    def __init__(self) -> None:
        super().__init__("memory search limit must be positive")
...
def fuse_rankings(
    *,
    ...
    """Fuse ordered channel candidates with RFC 0003 RRF semantics."""
