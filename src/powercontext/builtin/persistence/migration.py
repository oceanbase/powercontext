...
_POST_BRIDGE_TABLES = (PROFILE_POLICIES_TABLE, ARTIFACT_TAGS_TABLE, RECEIPT_MIGRATION_REVIEW_TABLE)
...
_BASE_TABLES = tuple(
    table
    for table in SHARED_TABLES + MEMORY_TABLES + STATISTICS_TABLES
