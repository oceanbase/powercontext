...
export const OPERATIONS = {
  ...
  list_operations: { method: 'GET', path: '/v1/operations', location: "query", scope: true },
  get_operation: { method: 'GET', path: '/v1/operations/{operation_id}', location: null, scope: false },
  cancel_operation: { method: 'POST', path: '/v1/operations/{operation_id}/cancel', location: "body", scope: false },
  retry_operation: { method: 'POST', path: '/v1/operations/{operation_id}/retry', location: "body", scope: false },
