...
export const OPERATIONS = {
  ...
  list_dream_runs: { method: 'GET', path: '/v1/scopes/{scope_id}/dream', location: "query", scopeMode: 'none', pathParameters: ['scope_id'], queryParams: ['status','operation','cursor','limit'], headerParams: [], successStatuses: [200], emptyStatuses: [] },
  create_dream_run: { method: 'POST', path: '/v1/scopes/{scope_id}/dream', location: "body", scopeMode: 'none', pathParameters: ['scope_id'], queryParams: [], headerParams: [], successStatuses: [202,200], emptyStatuses: [] },
  get_dream_run: { method: 'GET', path: '/v1/scopes/{scope_id}/dream/{run_id}', location: null, scopeMode: 'none', pathParameters: ['scope_id', 'run_id'], queryParams: [], headerParams: [], successStatuses: [200], emptyStatuses: [] },
  ...
  list_catalog_candidates: { method: 'POST', path: '/v1/catalog-change-candidates/list', location: "body", scopeMode: 'current', pathParameters: [], queryParams: [], headerParams: [], successStatuses: [200], emptyStatuses: [] },
  get_catalog_candidate: { method: 'POST', path: '/v1/catalog-change-candidates/get', location: "body", scopeMode: 'current', pathParameters: [], queryParams: [], headerParams: [], successStatuses: [200], emptyStatuses: [] },
  get_catalog_candidate_history: { method: 'POST', path: '/v1/catalog-change-candidates/history', location: "body", scopeMode: 'current', pathParameters: [], queryParams: [], headerParams: [], successStatuses: [200], emptyStatuses: [] },
  revise_catalog_candidate: { method: 'POST', path: '/v1/catalog-change-candidates/revise', location: "body", scopeMode: 'current', pathParameters: [], queryParams: [], headerParams: [], successStatuses: [200], emptyStatuses: [] },
  approve_catalog_candidate: { method: 'POST', path: '/v1/catalog-change-candidates/approve', location: "body", scopeMode: 'current', pathParameters: [], queryParams: [], headerParams: [], successStatuses: [200], emptyStatuses: [] },
  reject_catalog_candidate: { method: 'POST', path: '/v1/catalog-change-candidates/reject', location: "body", scopeMode: 'current', pathParameters: [], queryParams: [], headerParams: [], successStatuses: [200], emptyStatuses: [] },
